...
export default function ImportRecipeDialog (props: DialogProps<PayloadType, ReturnType>): React.ReactElement {
  ...
  return (
    <>
      <Dialog
        ...
        sx={{userSelect: 'none'}}
      >
        <DialogTitle id='ImportRecipeDialog-title'>
          Confirmation
        </DialogTitle>

        <DialogContent sx={{pb: 0}}>
          <DialogContentText id='ImportRecipeDialog-description' sx={{mb: 1}}>
